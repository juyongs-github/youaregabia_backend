    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors(Customizer.withDefaults())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/chatbot/sessions/**").authenticated()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/playlist/collabo/all").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/playlist/collabo/*").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/playlist/*/collabo/songs").permitAll()
