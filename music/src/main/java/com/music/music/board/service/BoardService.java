...
public class BoardService {
    ...
    public BoardDto getBoardDetail(Long boardId, Long userId, PageRequestDTO dto) {
        ...
        Page<ReplyResponseDto> repliyPage =
                replyRepository.findRepliesWithLikeInfo(boardId, userId, pageable);
        
        PageResultDTO<ReplyResponseDto> replies = PageResultDTO.<ReplyResponseDto>withAll()
                .dtoList(repliyPage.getContent())
                .totalCount(repliyPage.getTotalElements())
                .pageRequestDTO(dto)
                .build();
